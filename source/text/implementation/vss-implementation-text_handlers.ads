...
package VSS.Implementation.Text_Handlers is
   ...
   type Abstract_Text_Handler is abstract tagged null record;

   not overriding procedure Reference
     (Self : in out Abstract_Text_Handler) is abstract;
   ...
   not overriding function Is_Empty
     (Self : Abstract_Text_Handler) return Boolean is abstract;
   ...
   --  Return character at given position or No_Character if Position is not
   --  pointing to any character.
